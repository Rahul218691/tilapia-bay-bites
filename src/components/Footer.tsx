      ...
      <div className="container py-12">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-background/80">+91 (895) 114-9245</span>
              </div>
              <div className="flex items-center space-x-2">
                <Mail className="h-4 w-4 text-ocean" />
                <span className="text-background/80">tilapiabay.com</span>
              </div>
              <div className="flex items-center space-x-2">
                <MapPin className="h-4 w-4 text-ocean" />
                <span className="text-background/80">Bilijaji Road Hessaraghatta opposite wings and wonders</span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-background/20 mt-8 pt-8 text-center">
          <p className="text-sm text-background/60">
            © {new Date().getFullYear()} TilapiaBay. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
